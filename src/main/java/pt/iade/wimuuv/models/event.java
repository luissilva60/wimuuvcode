...
public class event {
    ...
    @Column(name="event_date") private int event_date;
    @Column(name="event_starttime") private int event_starttime;
    @Column(name="event_endtime") private int event_endtime;
    @Column(name="event_duration") private int event_duration;
